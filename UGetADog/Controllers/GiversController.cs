...
namespace UGetADog.Controllers
{
    public class GiversController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GiverID,Email,Password,FirstName,LastName,Address,Phone,Rating")] Giver giver)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GiverID,Email,Password,FirstName,LastName,Address,Phone,Rating")] Giver giver)
        {
            if (ModelState.IsValid)
            {
